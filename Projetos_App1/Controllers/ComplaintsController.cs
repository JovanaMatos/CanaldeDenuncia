...
namespace Projetos_App1.Controllers
{
    public class ComplaintsController : Controller
    {
        ...
        {
            var appDbContext = _context.Complaints.Include(c => c.CompaniesCategory).Include(c => c.CompanyRelation).Include(c => c.ComplaintStatus).Include(c => c.CurrentResponsible).Include(c => c.ShippingMethods);
